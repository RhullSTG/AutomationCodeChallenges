...
namespace AutomationCodeChallenge1
{
    public class NavbarLinks
    {
        ...
        public void NavBarNavigation(string navBarButton)
        {
            ...
            var planYourTripExpectedTitle = "All Services - Ski Utah";
            var resortsAndSnowExpectedTitle = "Get the Official Utah Snow Report - Ski Utah";
            var storiesExpectedTitle = "Read About the Latest Happenings on the Slopes - Ski Utah";
            var dealsExpectedTitle = "Ski and Snowboard The Greatest Snow on Earth® - Ski Utah";
            var passesExcpectedTitle = "2016-17 Season Passes - Ski Utah";
            var exploreExpectedTitle = "Utah Areas 101 - Ski Utah";


            if (navBarButton == "Plan Your Trip")
            {
                driver.Navigate().GoToUrl("https://www.skiutah.com/members/listing");
                var planYourTripActualTitle = driver.Title;
            ...
            if (navBarButton == "Resorts & Snow")
            {
                ...
                var resortsAndSnowActualTitle = driver.Title;
            ...
            if (navBarButton == "Stories")
            {
                ...
                var storiesActualTitle = driver.Title;
            ...
            if (navBarButton == "Deals")
            {
                ...
                var dealsActualTitle = driver.Title;
            ...
            if (navBarButton == "Passes")
            {
                ...
                var passesActualTitle = driver.Title;
            ...
            if (navBarButton == "Explore")
            {
                ...
                var exploreActualTitle = driver.Title;
        ...
        public void PlanYourTripSubMenu(string subNavBarBtn)
        {
            ...
            if (subNavBarBtn == "Reservation Experts")
            {
                var actionBtn =
                    wait.Until(
                        ExpectedConditions.ElementIsVisible(By.XPath("//a[contains(text(),\'Reservation Experts\')]")));
                action.Click(actionBtn).Perform();
            }
        ...
        public void ResortsAndSnowSubMenu(string subNavBarBtn)
        {
            ...
            if (subNavBarBtn == "Resort Comparison")
            {
                var actionBtn =
                    wait.Until(
                        ExpectedConditions.ElementIsVisible(By.XPath("//a[contains(text(),\'Resort Comparison\')]")));
                action.Click(actionBtn).Perform();
            }
                ...
                var actionBtn =
                    wait.Until(
                        ExpectedConditions.ElementIsVisible(
                            By.XPath("//a[contains(text(),\'Cross Country - Nordic Locations\')]")));
                action.Click(actionBtn).Perform();
            }
            ...
            if (subNavBarBtn == "Mobile App & TV Display")
            {
                var actionBtn =
                    wait.Until(
                        ExpectedConditions.ElementIsVisible(By.XPath("//a[contains(text(),\'Mobile App & TV Display\')]")));
                action.Click(actionBtn).Perform();
            }
            ...
            if (subNavBarBtn == "Live Mountain Cams")
            {
                var actionBtn =
                    wait.Until(
                        ExpectedConditions.ElementIsVisible(By.XPath("//a[contains(text(),\'Live Mountain Cams\')]")));
                action.Click(actionBtn).Perform();
            }
            ...
            if (subNavBarBtn == "Printable Snow Report")
            {
                var actionBtn =
                    wait.Until(
                        ExpectedConditions.ElementIsVisible(By.XPath("//a[contains(text(),\'Printable Snow Report\')]")));
                action.Click(actionBtn).Perform();
            }
        ...
        public void DealsSubMenu(string subNavBarBtn)
        {
            ...
            if (subNavBarBtn == "Lodging")
            {
                var actionBtn =
                    wait.Until(
                        ExpectedConditions.ElementIsVisible(By.XPath("//div[@id=\'top_menu\']/ul/li[4]/ul/li/ul/li[3]/a")));
                action.Click(actionBtn).Perform();
            }
            ...
            if (subNavBarBtn == "Transportation")
            {
                var actionBtn =
                    wait.Until(
                        ExpectedConditions.ElementIsVisible(By.XPath("//div[@id=\'top_menu\']/ul/li[4]/ul/li/ul/li[5]/a")));
                action.Click(actionBtn).Perform();
            }
            ...
            if (subNavBarBtn == "Learn to Ski Program")
            {
                var actionBtn =
                    wait.Until(
                        ExpectedConditions.ElementIsVisible(By.XPath("//a[contains(text(),\'Learn to Ski Program\')]")));
                action.Click(actionBtn).Perform();
            }
        ...
        public void PassesSubMenu(string subNavBarBtn)
        {
            ...
            if (subNavBarBtn == "Purchase Utah Lift Tickets")
            {
                var actionBtn =
                    wait.Until(
                        ExpectedConditions.ElementIsVisible(
                            By.XPath("//a[contains(text(),\'Purchase Utah Lift Tickets\')]")));
                action.Click(actionBtn).Perform();
            }
            ...
            if (subNavBarBtn == "5th and 6th Grade Passport")
            {
                var actionBtn =
                    wait.Until(
                        ExpectedConditions.ElementIsVisible(
                            By.XPath("//a[contains(text(),\'5th and 6th Grade Passport\')]")));
                action.Click(actionBtn).Perform();
            }
            ...
            if (subNavBarBtn == "Ski Utah Yeti Pass")
            {
                var actionBtn =
                    wait.Until(
                        ExpectedConditions.ElementIsVisible(By.XPath("//a[contains(text(),\'Ski Utah Yeti Pass\')]")));
                action.Click(actionBtn).Perform();
            }
            if (subNavBarBtn == "Transportation")
            {
